...
project = u'Nextcloud %s Manual do Usuário' % (version)
...
html_short_title = "Manual do Usuário"
...
htmlhelp_basename = 'NextcloudManualdoUsuário'
...
latex_documents = [
  ('contents', 'Nextcloud_User_Manual.tex', u'Nextcloud Manual do Usuário',
...
pdf_documents = [('contents', u'NextcloudManualdoUsuário', u'Nextcloud Manual do Usuário', u'O Desenvolvedor Nextcloud'),]
...
man_pages = [
    ('contents', 'NextcloudManualdoUsuário', u'Nextcloud Manual do Usuário', [u'O Desenvolvedor Nextcloud'], 1)
]
...
texinfo_documents = [
  ('contents', 'NextcloudManualdoUsuário', u'Nextcloud Manual do Usuário',
   u'O Desenvolvedor Nextcloud', 'Nextcloud', 'O Manual do Usuário Nextcloud.',
   'Miscellaneous'),
]
...
epub_title = u'Nextcloud Manual do Usuário'
epub_author = u'O Desenvolvedor Nextcloud'
epub_publisher = u'O Desenvolvedor Nextcloud'
epub_copyright = u'2012-2017, O Desenvolvedor Nextcloud'
...
current_docs = 'user_manual_pt-br'
