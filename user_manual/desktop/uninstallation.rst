...
3. You may also need to take into consideration that uninstalling the desktop client will not remove the
   :ref:`user's configuration <desktop-configuration-file>` file and synced data.
...
3. The :ref:`user's configuration <desktop-configuration-file>` is located at ``%APPDATA%\Nextcloud\nextcloud.cfg``.
...
3. From version 33.0.0 the :ref:`user's configuration <desktop-configuration-file>` is located at
...
3. The :ref:`user's configuration <desktop-configuration-file>` is located at *$HOME/.config/Nextcloud/nextcloud.cfg*.
