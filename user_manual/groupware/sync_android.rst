...
.. tip:: With DAVx⁵ and OpenTasks installed on your mobile device, you can usually use any calendar app with CalDAV support. First, follow the steps `above <https://docs.nextcloud.com/server/19/user_manual/pim/sync_android.html#without-the-nextcloud-mobile-app>`__ to install DAVx⁵ and OpenTasks. After that, open your calendar app - such as `Etar <https://github.com/Etar-Group/Etar-Calendar>`__, if you prefer a complete FOSS solution. In the settings, look for the option to 'Add CalDAV calendar' or similar. Your previously installed DAVx⁵ will open. The authentication procedure is the same as described in `Without the Nextcloud mobile app <https://docs.nextcloud.com/server/19/user_manual/pim/sync_android.html#without-the-nextcloud-mobile-app>`__. Select **Connection with URL and username** with the ``https://sub.example.com/remote.php/dav`` URL and ``Groups are per-contact categories`` option, to connect your calendar solution with Nextcloud.
