...
and the Nextcloud desktop client does the rest. Make a change on one computer and
it flows across the others using these desktop sync clients. You will always have
your latest files with you wherever you are.

Its usage is documented separately in the `Nextcloud Desktop Client Manual`_.

.. _`Nextcloud Desktop Client Manual`: https://docs.nextcloud.com/server/latest/user_manual/en/desktop/index.html
...
Bidirectional sync (two-way sync) has not yet been fully implemented in the Android
