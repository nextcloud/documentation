...
<https://docs.nextcloud.com/server/33/admin_manual/occ_command.html#encryption-label>`_
...
<https://docs.nextcloud.com/server/33/admin_manual/configuration_files/encryption_configuration.html#enabling-users-file-recovery-keys>`_, `"decrypt all"
<https://docs.nextcloud.com/server/33/admin_manual/occ_command.html#encryption-label>`_ will use it to decrypt all files.
...
<https://docs.nextcloud.com/server/33/admin_manual/configuration_files/encryption_configuration.html#enabling-users-file-recovery-keys>`_,
