...
files to you without having to log in to the server, and without being a Nextcloud user.
...
folder, click the link, and then you'll see a Nextcloud page with a "**Click to upload**" button:
