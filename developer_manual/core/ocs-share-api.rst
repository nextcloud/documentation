...
enabled and configured. See `Configuring Federated Cloud Sharing <https://docs.nextcloud.org/server/10/admin_manual/configuration_files/federated_cloud_sharing_configuration.html>`_.
