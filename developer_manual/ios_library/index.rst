...
`Nextcloud Contributor Agreement <https://nextcloud.org/contribute/agreement/>`_. You are 
permitted to test the iOS client on Apple hardware thanks to the 
`iOS license exception <https://nextcloud.org/contribute/iOS-license-exception/>`_.
