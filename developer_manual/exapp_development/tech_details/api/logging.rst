...
The possible values of ``log_lvl`` are described here: `Nextcloud Log level <https://docs.nextcloud.com/server/33/admin_manual/configuration_server/logging_configuration.html#log-level>`_
