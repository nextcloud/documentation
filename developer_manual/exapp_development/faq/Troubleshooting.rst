...
The deployment issues questions are covered in the `Test Deploy <https://docs.nextcloud.com/server/33/admin_manual/exapps_management/TestDeploy.html>`_ section of the administration guide.
