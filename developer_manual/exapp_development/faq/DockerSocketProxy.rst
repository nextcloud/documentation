...
See `Nextcloud in Docker AIO (all-in-one) <https://docs.nextcloud.com/server/33/admin_manual/exapps_management/DeployConfigurations.html#nextcloud-in-docker-aio-all-in-one>`_ for more details.
