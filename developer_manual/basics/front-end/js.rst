...
If that is the case, no additional shortcuts shall be registered by any app. Only :kbd:`Space`
to toggle checkboxes and :kbd:`Enter` to submit the currently active buttons or links are okay,
