...
enabled and configured. See `Configuring Federated Cloud Sharing <https://docs.nextcloud.com/server/33/admin_manual/configuration_files/federated_cloud_sharing_configuration.html>`_.
