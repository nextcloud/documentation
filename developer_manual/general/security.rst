...
Getting help
------------
If you need help to ensure that a function is secure please ask on our `mailing list <https://mailman.nextcloud.org/mailman/listinfo/devel>`_ or on our IRC channel **#nextcloud-dev** on **irc.freenode.net**.
