...
First `set up your Web server and database <https://docs.nextcloud.org/server/10/admin_manual/installation/index.html>`_ (**Section**: Manual Installation - Prerequisites).
...
* Using the `stable version <https://docs.nextcloud.org/server/10/admin_manual/#installation>`_
.. TODO ON RELEASE: Update version number above on release
