...
First `set up your Web server and database <https://docs.nextcloud.com/server/26/admin_manual/installation/index.html>`_ (**Section**: Manual Installation - Prerequisites).
...
* Using the `stable version <https://docs.nextcloud.com/server/26/admin_manual/installation/index.html>`_
