...
At each layer the goal is to provide the ability to scale, while providing a high
...
replicated volume with IP Fail Over.  The storage was configured on a separate
