...
* `OpenAI and LocalAI integration <https://apps.nextcloud.com/apps/integration_openai>`_ and `DeepL integration <https://apps.nextcloud.com/apps/integration_deepl>`_ apps are not yet supported for translation.
