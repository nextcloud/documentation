...
.. _the Nextcloud Forums: https://forum.nextcloud.org
...
* ``No basic authentication headers were found`` -> This error is shown in your
  ...
  found at the `forums <https://forum.nextcloud.org/viewtopic.php?f=17&t=30646>`_.
...
<https://forum.nextcloud.org/viewtopic.php?f=17&t=7536>`_
