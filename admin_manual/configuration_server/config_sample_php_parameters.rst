...
.. https://github.com/nextcloud/core/blob/master/config/config.sample.php
...
::
	...
	'customclient_desktop' =>
		'https://nextcloud.org/install/#install-clients',
	'customclient_android' =>
		'https://play.google.com/store/apps/details?id=com.nextcloud.android',
	'customclient_ios' =>
		'https://itunes.apple.com/us/app/nextcloud/id543672169?mt=8',
...
When set to ``true``, the Nextcloud instance will be unavailable for all users
...
by the server. Defaults to the minimum officially supported Nextcloud version at
...
When ``true``, prevent Nextcloud from changing the cache due to changes in the
