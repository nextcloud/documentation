...
To access the setup page below log in with an Admin account.  Click on your Profile
icon in the top right, and then click Settings.  On  the left sode under
Administration and click Basic settings.
